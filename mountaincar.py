...
MEMORY_SIZE = 2000 # used only for Non-Incremental learning, i.e. partial_fit=False
BATCH_SIZE = 20
...
def mountain_car():
    ...
    while True:
        ...
        while True:
            ...
            if terminal:
                print("Run: " + str(run) + ", exploration: " + str(dqn_solver.exploration_rate) + ", score: " + str(step) + ", max: " + str(max_position))
